    ...
    <div className="history__content">
      ...
      <article className="history__article">
        ...
        <p className="history__text">
          Пройдя по местам кровопролитных боев Полоцкого УРа, члены нашего поискового отряда нашли молчаливых свидетелей тех событий. Вот пулеметная лента, гильза от ПТР, диск под ППШ, минометный стабилизатор, немецкая обойма… Вместе с ними в нашем музее хранятся две каски, советская и немецкая – как напоминание о том, что смерть не делит солдат на своих и чужих, перед ней все равны – и защитники, и захватчики. <br />
          <br />
